...
texinfo_documents = [
    (
        ...
        author,
        "harbor",
        "Scripts and models analyzing docked protein ligand structures.",
        "Miscellaneous",
    ),
]
...
.. only:: html
    ...
    __ https://github.com/choderalab/harbor/tree/main/
        """
    + r"{{ docpath }}"
)
